			...
			switch(cmd) {
				...
				case "help": {
					...
					String[] info2 = {"  _    _      _       ",
									  ...
									  "\"start\" - Begins your empire. Can only happen once",
									  "          you have selected a planet.",
									  "\"exit\" - Exits out of the planet information screen.",
									  "",
					...
					String[] info3 = {"  _    _      _       ",
									  ...
									  "\"colonize\" - Colonizes another planet. Must already ",
									  "          have an established empire to use this.",
									  "",
									  "",
									  "Type < to navigate to the previous page.",
									  "Type 'exit' to return to space!"};
